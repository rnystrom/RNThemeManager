#
# Be sure to run `pod spec lint RNThemeManager.podspec' to ensure this is a
# valid spec.
#
...
Pod::Spec.new do |s|
  ...
  # s.description  = <<-DESC
  #                   An optional longer description of RNThemeManager
  #
  #                   * Markdown format.
  ...
  # s.authors      = { "Ryan Nystrom" => "rnystrom@whoisryannystrom.com", "other author" => "and email address" }
  #
  # If absolutely no email addresses are available, then you can use this form instead.
  #
  # s.author       = 'Ryan Nystrom', 'other author'

  # Specify the location from where the source should be retrieved.
  #
  s.source       = { :git => "https://github.com/rnystrom/RNThemeManager", :tag => "0.0.1" }
